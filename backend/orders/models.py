...
class Order(models.Model):
    ...
    tracking_number = models.CharField(max_length=100, blank=True, help_text='Carrier tracking number')
    carrier = models.CharField(max_length=50, blank=True, help_text='e.g. Pathao, Steadfast, RedX')
